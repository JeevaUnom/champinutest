...
// import '../pages/Competition.dart';  // Adjust path based on your project structure

// void _showCompetitonPopup(BuildContext context) {
//   showDialog(
//     context: context,
...
//                   context,
//                   MaterialPageRoute(
//                     builder: (context) => const competitionPage(option: 'Goals'),
//                   ),
//                 );
//               },
//             ),
...
//                   context,
//                   MaterialPageRoute(
//                     builder: (context) => const competitionPage(option: 'Drills'),
//                   ),
//                 );
//               },
//             ),
...
//                   context,
//                   MaterialPageRoute(
//                     builder: (context) => const competitionPage(option: 'Techniques'),
//                   ),
//                 );
//               },
//             ),
...
//                   context,
//                   MaterialPageRoute(
//                     builder: (context) => const competitionPage(option: 'Fitness'),
//                   ),
//                 );
//               },
//             ),
